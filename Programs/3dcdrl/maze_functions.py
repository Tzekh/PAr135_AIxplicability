...
def create_object(x, y, tid, idx, unvisible=False):
    global thing_count
    output = 'thing//#{} {{ x={:0.3f}; y={:0.3f};'.format(thing_count, x,y).split(' ')
    if invisible:
        output += 'type={}; id={}; coop=true; dm=true; single=true; skill1=true; skill2=true; skill3=true; skill4=true; skill5=true; invisible=true; }}'.format(tid, idx).split(' ')
    else:

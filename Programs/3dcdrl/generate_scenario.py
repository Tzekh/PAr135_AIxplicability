...
def parse_args():    
    ...
    parser.add_argument('--difficulty', type=int, default=4, help='the difficulty, used for color scenario and k item')
    ...
    parser.add_argument('--scenario_dir', type=str, default='scenarios/custom_scenarios/basefiles/', help='the distrance between cells in the scenario')
...
def gen_scenarios(func, args, kwargs={}):
    ...
    for stage, num in zip(['train/', 'test/'],
        ...
        for m in range(num):
            ...
            func.create_maze(base_filepath,
                             filename, 
                             size=args.size,
